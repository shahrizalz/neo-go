...
var rpcTestCases = map[string][]rpcTestCase{
	"getapplicationlog": {
		{
			name:   "positive",
			params: `["ce3f24523becab28cd7a629fc8c4ffa6bba175479b567d4eb1cc4b39488ba84f"]`,
			result: func(e *executor) interface{} { return &result.ApplicationLog{} },
			check: func(t *testing.T, e *executor, acc interface{}) {
				res, ok := acc.(*result.ApplicationLog)
				require.True(t, ok)
				expectedTxHash, err := util.Uint256DecodeStringLE("ce3f24523becab28cd7a629fc8c4ffa6bba175479b567d4eb1cc4b39488ba84f")
